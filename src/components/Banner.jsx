...
const Banner = () => {
  return (
    <div
      className='flex bg-green-400 rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'
      data-aos="fade-up"
      data-aos-delay="100"
    >
      {/* -----Left side------- */}
      ...
      >
        <img
          className='w-full absolute bottom-0 right-10 max-w-md'
          src={assets.appointment_img1}
...
const MultipleImageSlideshow = () => {
  ...
  return (
    <div
      className='relative w-[300px] h-[200px] sm:w-[400px] sm:h-[250px] md:w-[500px] md:h-[300px] lg:w-[1140px] lg:h-[350px] mx-auto mt-4 sm:mt-6 overflow-hidden rounded-lg shadow-lg'
      data-aos="zoom-in"
      data-aos-delay="400"
    >
      <img
