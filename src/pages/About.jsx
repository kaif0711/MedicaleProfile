...
const About = () => {
  ...
  useEffect(() => {
    document.title = "About | Mansuri Occupational Health Consultancy";
  }, []);
  ...
  return (
    <div className="text-gray-900 my-16 md:mx-10">
      {/* About Us Section */}
      <h1 className="text-4xl text-green-700 font-medium text-center mb-10 my-10">
        Services
      </h1>
      ...
      <section className="flex flex-col lg:flex-row items-center gap-10 px-4 max-w-6xl mx-auto mb-16">
        ...
        <div
          className="lg:w-1/2 text-lg leading-relaxed space-y-4"
          data-aos="fade-left"
        >
      ...
      <h1
        className="text-4xl font-medium text-green-700 text-center mb-12"
        data-aos="fade-down"
        data-aos-delay="100"
      >
        About
      ...
      >
        {(showAll ? images : images.slice(0, 4)).map((image, index) => (
          <div
            ...
            onClick={() => openModal(showAll ? index : index)}
          >
            <img
